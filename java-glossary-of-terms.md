...
class. Also called a *static method*. See also
*instance method*.
...
subclass of class Y. See also *derived from*.
...
preceded with 0x. See also *octal*.
...
methods defined in their *supertypes*. See also
*superclass*, *subclass*.
...
in the class. Also called a *field*. See also *class
variable*.
...
the Java virtual machine**\***. See also *compiler*,
*runtime system*.
